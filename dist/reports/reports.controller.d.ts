...
export declare class ReportsController {
    ...
    generateReport(generateReportDto: GenerateReportDto): Promise<import("entities/global.entity").ReportSnapshot>;
    getReportSnapshots(query: any): Promise<import("common/crud.service").CustomPaginatedResponse<import("entities/global.entity").ReportSnapshot>>;
    getReportSnapshot(id: string): Promise<import("entities/global.entity").ReportSnapshot>;
